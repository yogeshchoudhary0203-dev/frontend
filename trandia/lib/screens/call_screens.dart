                    ...
                    Stack(
                      ...
                      children: [
                        ...
                        _Avatar(
                          letter: letter,
                          dark: widget.dark,
                          gradient: monoAvatar(widget.dark, 1),
                        ),
                      ],
                    ),
                  ...
                  child: Column(
                    children: [
                      ...
                      _StatusChip(
                        ...
                        label: statusLabel,
                        connected:
                            _callState == CallState.connected && !_declined,
                      ),
                      const SizedBox(height: 40),
  ...
  Widget _buildLocalView() {
    ...
    return AgoraVideoView(
      controller: VideoViewController(
        rtcEngine: _agora.rtcEngine!,
        canvas: VideoCanvas(uid: AgoraService.buildNumericUid(widget.myUserId)),
      ),
    );
  }
    ...
    return SizedBox(
      ...
      child: Row(
        ...
        children: List.generate(bars, (i) {
          final phase = i / bars;
          final h =
              (math.sin((value + phase) * math.pi * 2) * 0.5 + 0.5) * 36 + 8;
  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: Column(
      ...
      children: [
        ...
        Text(
          label,
          style: manrope(size: 12, weight: FontWeight.w600, color: labelColor),
        ),
      ],
    ),
  );
